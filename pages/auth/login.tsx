...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className=" flex flex-col justify-between md:items-center md:justify-center min-h-screen  ">
        <main className=" md:border md:border-[#BDBDBD] rounded-3xl px-4 py-8 md:p-12 md:w-[500px]">
          <Logo />
          <p className=" font-semibold text-lg mt-6 mb-4">Login</p>
          ...
          <p className="mt-6 text-center">
            ...
            <Link href="/auth/signup" className="text-[#2D9CDB]">
              Register
            </Link>
          </p>
        </main>
