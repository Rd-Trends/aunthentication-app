...
const PrivacyPolicy = () => {
  return (
    <div className="my-8 mx-4 md:mx-10 [&>*]:my-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to auth-app.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to auth-app, accessible from{" "}
            <a href="https://rd-auth-app.vercel.app" rel="norefferer">
      ...
      <ul>
        <li>By email: dannirolands@gmail.com</li>
      </ul>
    </div>
  );
};
