...
const TermOfService = () => {
  return (
    <div  className="my-8 mx-4 md:mx-10 [&>*]:my-4">
      <h2>
      ...
      <p>
        ...
        of auth-app's Website, located at{" "}
        <Link className="font-medium" href="/">https://rd-auth-app.vercel.app</Link>
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use auth-app if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing auth-app, you agreed to use
        cookies in agreement with the auth-app's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, auth-app and/or its licensors own the
        intellectual property rights for all material on auth-app. All
        intellectual property rights are reserved. You may access this from
        auth-app for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from auth-app</li>
        <li>Sell, rent or sub-license material from auth-app</li>
        <li>Reproduce, duplicate or copy material from auth-app</li>
        <li>Redistribute content from auth-app</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        auth-app does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of auth-app,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, auth-app shall not be liable
      ...
      <p>
        auth-app reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant auth-app a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of auth-app; and (d) the link is
      ...
      <p>
        ...
        e-mail to auth-app. Please include your name, your organization name,
      ...
      <p>
        No use of auth-app's logo or other artwork will be allowed for linking
